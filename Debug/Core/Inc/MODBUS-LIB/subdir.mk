...
C_SRCS += \
../Core/Inc/MODBUS-LIB/modbus_config.c \
../Core/Inc/MODBUS-LIB/modbus_crc.c 

OBJS += \
./Core/Inc/MODBUS-LIB/modbus_config.o \
./Core/Inc/MODBUS-LIB/modbus_crc.o 

C_DEPS += \
./Core/Inc/MODBUS-LIB/modbus_config.d \
./Core/Inc/MODBUS-LIB/modbus_crc.d 
...
clean-Core-2f-Inc-2f-MODBUS-2d-LIB:
	-$(RM) ./Core/Inc/MODBUS-LIB/modbus_config.cyclo ./Core/Inc/MODBUS-LIB/modbus_config.d ./Core/Inc/MODBUS-LIB/modbus_config.o ./Core/Inc/MODBUS-LIB/modbus_config.su ./Core/Inc/MODBUS-LIB/modbus_crc.cyclo ./Core/Inc/MODBUS-LIB/modbus_crc.d ./Core/Inc/MODBUS-LIB/modbus_crc.o ./Core/Inc/MODBUS-LIB/modbus_crc.su
