...
Core/Src/Modes/%.o: ../Core/Src/Modes/%.c Core/Src/Modes/subdir.mk
...
clean-Core-2f-Src-2f-Modes:
	-$(RM) ./Core/Src/Modes/modes.d ./Core/Src/Modes/modes.o ./Core/Src/Modes/smart_mode_external.d ./Core/Src/Modes/smart_mode_external.o
