...
Core/Src/Sensor/%.o: ../Core/Src/Sensor/%.c Core/Src/Sensor/subdir.mk
...
clean-Core-2f-Src-2f-Sensor:
	-$(RM) ./Core/Src/Sensor/sensor.d ./Core/Src/Sensor/sensor.o ./Core/Src/Sensor/sht.d ./Core/Src/Sensor/sht.o
